...
#include "solution_interfaces/msg/detail/clusters__type_support.h"
...
static const _Clusters_type_support_symbol_names_t _Clusters_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solution_interfaces, msg, Clusters)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, solution_interfaces, msg, Clusters)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, solution_interfaces, msg, Clusters)() {
  return &::solution_interfaces::msg::rosidl_typesupport_c::Clusters_message_type_support_handle;
}
