...
solution_interfaces__msg__WorldItem__init(solution_interfaces__msg__WorldItem * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->colour)) {
    solution_interfaces__msg__WorldItem__fini(msg);
    return false;
  }
  return true;
}
...
solution_interfaces__msg__WorldItem__create()
{
  ...
  solution_interfaces__msg__WorldItem * msg = (solution_interfaces__msg__WorldItem *)allocator.allocate(sizeof(solution_interfaces__msg__WorldItem), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(solution_interfaces__msg__WorldItem));
  bool success = solution_interfaces__msg__WorldItem__init(msg);
  if (!success) {
...
solution_interfaces__msg__WorldItem__Sequence__init(solution_interfaces__msg__WorldItem__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  solution_interfaces__msg__WorldItem * data = NULL;

  if (size) {
    data = (solution_interfaces__msg__WorldItem *)allocator.zero_allocate(size, sizeof(solution_interfaces__msg__WorldItem), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = solution_interfaces__msg__WorldItem__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        solution_interfaces__msg__WorldItem__fini(&data[i - 1]);
      }
...
solution_interfaces__msg__WorldItem__Sequence__fini(solution_interfaces__msg__WorldItem__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      solution_interfaces__msg__WorldItem__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  solution_interfaces__msg__WorldItem__Sequence * array = (solution_interfaces__msg__WorldItem__Sequence *)allocator.allocate(sizeof(solution_interfaces__msg__WorldItem__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = solution_interfaces__msg__WorldItem__Sequence__init(array, size);
  if (!success) {
...
solution_interfaces__msg__WorldItem__Sequence__destroy(solution_interfaces__msg__WorldItem__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    solution_interfaces__msg__WorldItem__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
solution_interfaces__msg__WorldItem__Sequence__are_equal(const solution_interfaces__msg__WorldItem__Sequence * lhs, const solution_interfaces__msg__WorldItem__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!solution_interfaces__msg__WorldItem__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  solution_interfaces__msg__WorldItem__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(solution_interfaces__msg__WorldItem);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    solution_interfaces__msg__WorldItem * data =
      (solution_interfaces__msg__WorldItem *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!solution_interfaces__msg__WorldItem__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          solution_interfaces__msg__WorldItem__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!solution_interfaces__msg__WorldItem__copy(
