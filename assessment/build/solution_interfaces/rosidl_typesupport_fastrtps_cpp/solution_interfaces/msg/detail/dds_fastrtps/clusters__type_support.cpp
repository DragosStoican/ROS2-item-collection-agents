...
#include "solution_interfaces/msg/detail/clusters__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const solution_interfaces::msg::Cluster &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  solution_interfaces::msg::Cluster &);
...
// functions for solution_interfaces::msg::Cluster already declared above
...
cdr_serialize(
  const solution_interfaces::msg::Clusters & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  solution_interfaces::msg::Clusters & ros_message)
{
  // Member: red
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: red
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        solution_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Cluster(
  ...
  if (is_plain) {
    ...
    using DataType = solution_interfaces::msg::Clusters;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const solution_interfaces::msg::Clusters *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<solution_interfaces::msg::Clusters *>(
    untyped_ros_message);
...
{
  return &solution_interfaces::msg::typesupport_fastrtps_cpp::_Clusters__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, solution_interfaces, msg, Clusters)() {
  return &solution_interfaces::msg::typesupport_fastrtps_cpp::_Clusters__handle;
}
