...
bool solution_interfaces__msg__world_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("solution_interfaces.msg._world_item.WorldItem", full_classname_dest, 45) == 0);
  }
  solution_interfaces__msg__WorldItem * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of WorldItem */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("solution_interfaces.msg._world_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WorldItem");
