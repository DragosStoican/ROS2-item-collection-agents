...
bool solution_interfaces__msg__cluster__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("solution_interfaces.msg._cluster.Cluster", full_classname_dest, 40) == 0);
  }
  solution_interfaces__msg__Cluster * ros_message = _ros_message;
  {  // x
...
PyObject * solution_interfaces__msg__cluster__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("solution_interfaces.msg._cluster");
  ...
  solution_interfaces__msg__Cluster * ros_message = (solution_interfaces__msg__Cluster *)raw_ros_message;
  {  // x
    PyObject * field = NULL;
