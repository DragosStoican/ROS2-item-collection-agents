...
bool solution_interfaces__msg__world_items__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("solution_interfaces.msg._world_items.WorldItems", full_classname_dest, 47) == 0);
  }
  solution_interfaces__msg__WorldItems * ros_message = _ros_message;
  {  // red
    ...
    solution_interfaces__msg__WorldItem * dest = ros_message->red.data;
  ...
  {  // green
    ...
    solution_interfaces__msg__WorldItem * dest = ros_message->green.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!solution_interfaces__msg__world_item__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // blue
    ...
    solution_interfaces__msg__WorldItem * dest = ros_message->blue.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!solution_interfaces__msg__world_item__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * solution_interfaces__msg__world_items__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of WorldItems */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("solution_interfaces.msg._world_items");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WorldItems");
  ...
  solution_interfaces__msg__WorldItems * ros_message = (solution_interfaces__msg__WorldItems *)raw_ros_message;
  {  // red
    PyObject * field = NULL;
